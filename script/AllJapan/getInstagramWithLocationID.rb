...
puts "/"
      ...
      db.execute(sql,scene_id.to_i,picture_id.to_i,label,nil,nil,score.to_f,insta_spot_id.to_i)
      puts(sql,scene_id.to_i,picture_id.to_i,label,nil,nil,score.to_f,insta_spot_id.to_i)
puts "/"
...
puts "/"
      ...
      db.execute(sql,tag_id.to_i,nil,nil,picture_id,tag,insta_spot_id.to_i)
      puts(sql,tag_id.to_i,nil,nil,picture_id,tag,insta_spot_id.to_i)
puts "/"
