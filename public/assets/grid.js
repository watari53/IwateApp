  ...
  update : function( $item ) {
   ...
   var $itemEl = this.$item.children( 'a' ),
    eldata = {
     ...
     title : $itemEl.data( 'title' ),
     description : $itemEl.data( 'description' )
     //destlat : $itemEl.data( 'destlat' )
     //destlon : $itemEl.data( 'destlon' )
     //alert(title);
    };

   //alert(eldata.href.split("dstlat")[1].split("&")[0].split("=")[1]);
   //alert(eldata.href.split("dstlng")[1].split("&")[0].split("=")[1]);

   this.$title.html( eldata.title );
   this.$description.html( eldata.description );
   //var aa= this.$href.replace(/DESTLAT/g,"1").replace(/DESTLON/g,"1");
   //this.$href = $( '<a href="#">撮影場所への道順</a>' );
   //this.$href.attr( 'href', eldata.href );
   //this.$href.attr( 'href', eldata.destlat );
